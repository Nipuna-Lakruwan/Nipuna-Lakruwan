<table>
  <tr>
    ...
    <td width="70%" valign="center">
      ...
      <p>
        🔭 <b>Current Focus:</b> Docker, Kubernetes & CI/CD Pipelines<br>
        🎓 <b>Undergraduate:</b> Information Technology
      </p>
      <p>
        ⚙️ <b>I use daily:</b> <code>.py</code> <code>.yml</code> <code>.dockerfile</code> <code>.sh</code> <code>.json</code><br>
        🔨 Uhhh, I try to automate my entire life btw.
      </p>
      <a href="https://github.com/nipuna-lakruwan">
        <img src="https://komarev.com/ghpvc/?username=nipuna-lakruwan&style=flat&color=58A6FF&label=Profile+Views" alt="Views" />
      </a>
    </td>
  </tr>
</table>
